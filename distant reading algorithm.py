...
# Extract the text column (adjust 'Statements ' to match the actual column name)
texts = df['Statements '].tolist()  # Ensure the column name matches exactly
...
# Rotate x-ticks for readability and adjust font size
...
# Visualisation: Bigram Frequency Bar Chart
plt.figure(figsize=(9, 5), dpi=300)  # Adjust size for bigram chart
